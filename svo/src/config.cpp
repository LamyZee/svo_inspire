...
Config::Config() :
    ...
    init_min_tracked(vk::getParam<int>("svo/init_min_tracked", 15)),
    init_min_inliers(vk::getParam<int>("svo/init_min_inliers", 10)),
    ...
    triang_min_corner_score(vk::getParam<double>("svo/triang_min_corner_score", 5.0)),
    triang_half_patch_size(vk::getParam<int>("svo/triang_half_patch_size", 4)),
    subpix_n_iter(vk::getParam<int>("svo/subpix_n_iter", 30)),
    max_n_kfs(vk::getParam<int>("svo/max_n_kfs", 10)),
    img_imu_delay(vk::getParam<double>("svo/img_imu_delay", 0.0)),
    max_fts(vk::getParam<int>("svo/max_fts", 180)),
    quality_min_fts(vk::getParam<int>("svo/quality_min_fts", 10)),
